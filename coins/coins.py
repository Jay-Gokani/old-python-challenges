...
class Coin:
    def __init__(self, rare = False, clean = True, heads = True, **kwargs):
        ...
        for key, value in kwargs.items():       # This pulls in the dictionary to the parent
...
class Twenty_Pence(Coin):
    ...
    def rust(self):
        self.colour = self.clean_colour     # Polymorphism = when a methos has multiple forms in a class

    def clean(self):
        self.colour = self.clean_colour     # As this coin doesn't rust
...
# We're making a dictionary of data which is packed into kwargs to link the below values with the parent
class One_Pound(Coin):              # The brackets means it inherits another class
    def __init__(self):
        data = {
            "original_value": 1.00,
            "clean_colour": "gold",
